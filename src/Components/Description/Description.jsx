...
const Description = () => {
  return (
    <div className='mx-12 my-20'>
        <div className="flex">
            <div className="flex items-center justify-center text-base font-semibold w-[150px] h-[50px] border border-[#d0d0d0] cursor-pointer">
                Description
            </div>
            <div className="flex items-center justify-center text-base font-semibold w-[150px] h-[50px] border border-[#d0d0d0] bg-[#fbfbfb] text-[#555] cursor-pointer">
                Review (135)
            </div>
        </div>
